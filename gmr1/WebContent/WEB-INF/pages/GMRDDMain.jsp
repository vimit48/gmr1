...
function exportGMRDDLink(e){
    e.href = e.href + "?inputFile=" + document.getElementById('inputFile').value;
}
</script>
...
<body>
   ...
   <br>
  Browse Data Dictionary: <input type="text" style="border: 2px solid #dadada; border-radius: 7px;" id="inputFile" >
